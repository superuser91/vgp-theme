			...
			<div class="w-full swiper newsboard">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<a href="<?php echo setting('home_slide_overview_1_link')  ?>" class="w-image-block w-full">
							<img src="<?php echo setting('home_slide_overview_1')  ?>" alt="" />
						</a>
					</div>
					<div class="swiper-slide">
			...
			<div class="block-news aspect-[585/390] text-[.9em] p-[1em] mt-[1em] lg:text-[1em] lg:p-[2em]">
				<div class="title flex justify-between items-center">
					<div class="text-white px-[1em] py-[.4em] bg-secondary">
						<?php echo get_theme_mod('starter_new_setting_name') ?>
					</div>
