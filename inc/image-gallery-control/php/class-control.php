...
class Control extends \WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => __( 'Chọn ảnh', 'customize-image-gallery-control' ),
			'change'       => __( 'Cập nhật', 'customize-image-gallery-control' ),
			'default'      => __( 'Mặc định', 'customize-image-gallery-control' ),
			'remove'       => __( 'Xoá', 'customize-image-gallery-control' ),
			'placeholder'  => __( 'Chưa có ảnh nào', 'customize-image-gallery-control' ),
			'frame_title'  => __( 'Chọn ảnh', 'customize-image-gallery-control' ),
			'frame_button' => __( 'Chọn ảnh', 'customize-image-gallery-control' ),
		) );
	}
